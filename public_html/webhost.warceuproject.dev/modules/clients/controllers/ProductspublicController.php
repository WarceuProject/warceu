...
class Clients_ProductspublicController extends CE_Controller_Action
{
    ...
    protected function productAction()
    {
        ...
        $this->view->boxesClasses = 'col-xl-3 col-lg-4 col-md-6 col-sm-6';
        if ($recurringFee->getPaymentTerm() == 0) {
            $this->view->showRecurring = false;
            $this->view->boxesClasses = 'col-xl-4 col-lg-4 col-md-6 col-sm-6';
        }
    ...
    protected function productsAction()
    {
        ...
        $this->view->packages = $userPackageGateway->getClientPackagesList(false, true);
    }
